...
int main(){
  ...
  do{
    ...
    system("cls"); //Limpia la pantalla ejecutando un script propio de la terminal de comandos.
  ...
  switch(opcion) {
    ...
    case 2:
      system("cls"); //Limpia la pantalla ejectunado un script propio de la terminal.
